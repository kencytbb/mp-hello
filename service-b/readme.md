...
This will create an executable jar file **mp-miracle.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/mp-miracle.jar 
